...
```bash
  g++ -o main main_v3.cpp bubbleSort.cpp heapSort.cpp quickSort.cpp selectionSort.cpp mergeSort.cpp splaySort.cpp insertionSort.cpp datasetGenerator_v2.cpp -pthread
```
