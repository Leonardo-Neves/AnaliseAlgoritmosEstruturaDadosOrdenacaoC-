...
DatasetGenerator::DatasetGenerator(const std::vector<int>& lengthLists) : lengthLists(lengthLists) {}

std::vector<std::vector<int>> DatasetGenerator::generateOrdered() {
...
std::vector<std::vector<int>> DatasetGenerator::generateOrderedInverse() {
    std::vector<std::vector<int>> result;
    for (int length : lengthLists) {
...
std::vector<std::vector<int>> DatasetGenerator::generateAlmostOrdered() {
    std::vector<std::vector<int>> result;
...
std::vector<std::vector<int>> DatasetGenerator::generateRandom() {
    std::vector<std::vector<int>> result;
    std::random_device rd;
    std::mt19937 g(rd());
    for (int length : lengthLists) {
